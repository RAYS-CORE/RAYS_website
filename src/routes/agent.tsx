...
const downloads: DownloadCard[] = [
  {
    ...
    image: macImg,
    icon: Apple,
    filename: "RAYS.Studio-1.0.0-arm64.dmg",
    href: `${GITHUB_REPO_URL}/releases/download/v1.6.1/RAYS.Studio-1.0.0-arm64.dmg`,
  },
  {
    os: "Windows",
    tag: "x64 · .exe",
    image: winImg,
    icon: MonitorDown,
    filename: "RAYS.Studio.exe",
    href: `${GITHUB_REPO_URL}/releases/download/v1.6.1/RAYS.Studio.exe`,
  },
  {
    os: "Linux",
    tag: "Coming soon",
